...
- 07 触发买点信号并发送微信通知：`user-story-07-buy-signal-alert.md`
- 08 触发卖点信号并发送微信通知：`user-story-08-sell-signal-alert.md`
- 09 告警频控与勿扰控制：`user-story-09-alert-frequency-and-dnd.md`
- 10 收盘后日行情快照落库：`user-story-10-daily-snapshot-job.md`
- 11 异常与容错处理：`user-story-11-exception-and-resilience.md`
