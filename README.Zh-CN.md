...
**自选工作台。** 监控个人自选股：最新价、持仓盈亏、止损参考价和策略信号集中展示。持仓由用户自行登记；提醒通过微信和/或邮件送达。

![自选工作台](docs/images/homepage.png)

**回测详情。** 用历史数据检验参数组合——胜率、盈亏比、回撤，以及 K 线上标注的买卖与止损点——让设置有据可依，而不是凭感觉。

![回测详情](docs/images/backtest-detail.png)
